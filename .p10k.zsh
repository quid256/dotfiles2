# Generated by Powerlevel10k configuration wizard on 2020-01-12 at 11:48 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 15359.
# Wizard options: powerline, lean, 1 line, compact, concise, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%Bﬦ%b'
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=12
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=12
  ...
  ################[ goenv: go environment (https://github.com/syndbg/goenv) ]################
  # Goenv color.
  typeset -g POWERLEVEL9K_GOENV_FOREGROUND=12
